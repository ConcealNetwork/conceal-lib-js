...
const _bigintegerExport = (() => {
  ...
  BigInteger._construct = (n, s) => new BigInteger(n, s, CONSTRUCT);
  ...
  (() => {
    function makeUnary(fn) {
      return (a) => fn.call(BigInteger(a));
    }

    function makeBinary(fn) {
      return (a, b) => fn.call(BigInteger(a), BigInteger(b));
    }

    function makeTrinary(fn) {
      return (a, b, c) => fn.call(BigInteger(a), BigInteger(b), BigInteger(c));
    }
    ...
    (() => {
      ...
      BigInteger.exp10 = (x, n) => BigInteger(x).exp10(n);
    })();
  })();
...
export const JSBigInt = _bigintegerExport;
