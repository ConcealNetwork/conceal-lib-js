...
export interface InitOutput {
    ...
    readonly check_ring_signature: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly check_signature: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly check_tx_proof: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    ...
    readonly generate_key_image: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly generate_keys: (a: number, b: number) => [number, number, number];
    readonly generate_ring_signature: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
    readonly generate_signature: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly hash_to_ec: (a: number, b: number) => [number, number, number, number];
    readonly hash_to_ec160: (a: number, b: number) => [number, number, number, number];
    ...
    readonly scan_receive_outputs: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number];
    readonly scan_receive_outputs_batch: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number, number, number];
    readonly ge_tobytes: (a: number, b: number) => [number, number, number, number];
    readonly hash_to_ec32: (a: number, b: number) => [number, number, number, number];
    readonly argon2id: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
