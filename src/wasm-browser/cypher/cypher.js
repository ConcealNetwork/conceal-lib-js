 ...
 * @returns {Uint8Array}
 */
export function chacha12(key, nonce, data) {
    ...
    const ret = wasm.chacha12(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function chacha8(key, nonce, data) {
    const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(nonce, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.chacha8(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cypher_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
